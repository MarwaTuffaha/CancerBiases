% Classify_3mer_Codon_Mutations_SynNonsyn
...
codon_muts=load('Path_To\Data_Extracted_files\Codon_Content_Mutations.mat');
RR=codon_muts.R;
...
%% Now repeat for noncancer genes
R=RNC;
r=length(R);
...
C_syn_nc=C_syn;
C_nonsyn_nc=C_nonsyn;


save('Path_To\Data_Extracted_files\codon_3mer_CancerGenes_synNonsyn','C_syn_c','C_nonsyn_c','C_syn_nc','C_nonsyn_nc')
