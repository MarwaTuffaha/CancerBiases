 ...
 % counts | not normalized by genome content
...
CGS_syn_all= P_syn_c;
CGS_syn_tissues=P_syn_tissues_c;
P_syn_nc=sum(P_syn_tissues_nc,2);
NCGS_syn_all= P_syn_nc;
NCGS_syn_tissues=P_syn_tissues_nc;

P_syn_hyper_c=sum(P_syn_tissues_hyper_c,2);
P_syn_nonhyper_c=sum(P_syn_tissues_nonhyper_c,2);
CGS_syn_hyper= P_syn_hyper_c;
CGS_syn_nonhyper= P_syn_nonhyper_c;
CGS_syn_tissues_hyper=P_syn_tissues_hyper_c;
CGS_syn_tissues_nonhyper=P_syn_tissues_nonhyper_c;

P_syn_hyper_nc=sum(P_syn_tissues_hyper_nc,2);
P_syn_nonhyper_nc=sum(P_syn_tissues_nonhyper_nc,2);
NCGS_syn_hyper= P_syn_hyper_nc;
NCGS_syn_nonhyper= P_syn_nonhyper_nc;
NCGS_syn_tissues_hyper=P_syn_tissues_hyper_nc;
NCGS_syn_tissues_nonhyper=P_syn_tissues_nonhyper_nc;

CGS_syn_Germline=G_syn_c;
NCGS_syn_Germline=G_syn_nc;

P_nonsyn_c=sum(P_nonsyn_tissues_c,2);
CGS_nonsyn_all= P_nonsyn_c;
CGS_nonsyn_tissues=P_nonsyn_tissues_c;

P_nonsyn_nc=sum(P_nonsyn_tissues_nc,2);
NCGS_nonsyn_all= P_nonsyn_nc;
NCGS_nonsyn_tissues=P_nonsyn_tissues_nc;

P_nonsyn_hyper_c=sum(P_nonsyn_tissues_hyper_c,2);
P_nonsyn_nonhyper_c=sum(P_nonsyn_tissues_nonhyper_c,2);
CGS_nonsyn_hyper= P_nonsyn_hyper_c;
CGS_nonsyn_nonhyper= P_nonsyn_nonhyper_c;
CGS_nonsyn_tissues_hyper=P_nonsyn_tissues_hyper_c;
CGS_nonsyn_tissues_nonhyper=P_nonsyn_tissues_nonhyper_c;

P_nonsyn_hyper_nc=sum(P_nonsyn_tissues_hyper_nc,2);
P_nonsyn_nonhyper_nc=sum(P_nonsyn_tissues_nonhyper_nc,2);
NCGS_nonsyn_hyper= P_nonsyn_hyper_nc;
NCGS_nonsyn_nonhyper= P_nonsyn_nonhyper_nc;
NCGS_nonsyn_tissues_hyper=P_nonsyn_tissues_hyper_nc;
NCGS_nonsyn_tissues_nonhyper=P_nonsyn_tissues_nonhyper_nc;

CGS_nonsyn_Germline=G_nonsyn_c;
NCGS_nonsyn_Germline=G_nonsyn_nc;
