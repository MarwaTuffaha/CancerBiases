...
load("Path_To\Data_Extracted_files\Spectra_Counts.mat","spectrum_all","spectrum_tissues","spectrum_hyper","spectrum_tissues_hyper","spectrum_nonhyper","spectrum_tissues_nonhyper","spectrum_Germline")
load("Path_To\Data_Extracted_files\Spectra_ExceptTissue_Counts.mat","spectrum_ExceptTissue","spectrum_hyper_ExceptTissue","spectrum_nonhyper_ExceptTissue")
...
sgtitle("Hyper-mutated samples - Counts spectra")
close
...
sgtitle("Nonhyper-mutated samples - Counts spectra")
close
...
title("Correlating spectra of different tissues with the Germline Spectrum - Counts spectra")
...
xticks([ 1 2 3])
xticklabels({ sprintf('All samples'), sprintf('Hyper-mutated Samples'), sprintf('Nonhyper-mutated samples')})
title("Correlating spectra of different tissues with Other Tissues spectra - Counts Spectra")
